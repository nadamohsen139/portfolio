...
export const projects = [
  ...
  },
  {
    ...
    technologies: [
      ...
      "Supabase Storage (for storing Profile Pics)",
      "Expo image picker",
      "Adzuna API for displaying job postings",
    ],
  },
  {
    ...
    technologies: [
      ...
      "Gemini Google Generative Ai (for creating the trip plans)",
      "Unsplash",
      "Moment.js",
    ],
  },
  {
    href: "https://effervescent-dasik-70ca44.netlify.app/",
    imgSrc: ecommerce,
